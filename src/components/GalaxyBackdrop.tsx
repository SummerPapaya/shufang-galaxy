    ...
    >
      ...
      <div
        ...
        style={{
          ...
          mixBlendMode: 'screen',
          background:
            'radial-gradient(ellipse 75% 55% at 24% 26%, rgba(88,62,168,0.42) 0%, transparent 64%),' +
            'radial-gradient(ellipse 60% 48% at 78% 66%, rgba(120,42,96,0.32) 0%, transparent 60%),' +
            'radial-gradient(ellipse 90% 70% at 50% 48%, rgba(28,92,170,0.26) 0%, transparent 72%)',
        }}
      />
    </div>
  )
